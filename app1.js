...
function showApp(){
  ...
  const now = new Date();
  selectedDay=now; selectedDayJulian=now;
...
function setupTecnico(){
  ...
  document.getElementById('bottom-nav').innerHTML=`
    <button class="bnav-btn active" id="bn-tec-today" onclick="tecTab('today')">
      <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" width="20" height="20"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" stroke-width="2"/><polyline points="9 22 9 12 15 12 15 22" stroke-width="2"/></svg>
      MIS TAREAS</button>
  `;
